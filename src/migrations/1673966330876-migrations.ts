...
export class migrations1673966330876 implements MigrationInterface {
    name = 'migrations1673966330876'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying(50) NOT NULL, "password" character varying NOT NULL, "username" character varying(50) NOT NULL, "name" character varying(50) NOT NULL, "avatarUrl" character varying, "bio" character varying(300), "level" character varying(30), "contact" character varying(100), "isActive" boolean NOT NULL DEFAULT true, "isAdm" boolean DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "forgotPassword" character varying, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
